...
<body>
    ...
    <video autoplay loop muted>
      ...
      Your browser does not support the video tag.
        ...
        <form id="login" class="input-group" name="form-login" action="registration.php" method="POST">
    ...
    <form id="register" class="input-group" name="form-register" action="registration.php" method="POST">
            ...
            <input type="checkbox" class="checkbox"><span class="span-btn" name="register_agree">I agree to terms and Conditions</span>
